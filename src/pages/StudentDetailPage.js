...
const StudentDetailPage = () => {
    ...
    const [studentInfo, setStudentInfo] = useState({ 
      ...
      useEffect( () => {
        const fetchData = async () => {
          const result = await fetch(`${CONSTANTS.BASE_API_URL}student/{id}`);
    ...
    return (
        <React.Fragment>
            ...
            <h4>Student with ID = {id} is {studentInfo.firstName} {studentInfo.lastName} in {studentInfo.school}</h4>
